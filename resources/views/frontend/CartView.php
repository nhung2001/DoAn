...
<div class="template-cart">
    ...
    <div class="table-responsive">
      <table class="table table-cart">
        ...
        <?php foreach($_SESSION['cart'] as $product): ?>
          <tr>
            <td><img src="../assets/upload/products/<?php echo $product['photo']; ?>" class="img-responsive" 
              style="height: 109px; width: 85px; margin-left: 10px;"/></td>
              <!--xem sp chi tiet theo id khi kich ten sp-->
  ...
  <div class="total-cart"> Tổng tiền thanh toán:
    ...
    <a href="index.php?controller=cart&action=checkout" class="button black" onclick="return window.confirm('Bạn có muốn thanh toán không?')">Thanh toán</a> </div>
</div>