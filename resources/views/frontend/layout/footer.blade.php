<footer id="footer">
    <div class="top-footer">
        <div class="container">
            ...
            <div class="payments-method">
                <img src="{{ asset('frontend/themes/assets/payments-method221b.png?1481775169361') }}"
                    alt="Phương thức thanh toán" title="Phương thức thanh toán">
            </div>
        </div>
    </div>
    <div class="bottom-footer">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-5"> NShop</div>
