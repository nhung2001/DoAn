...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('frontend/themes/assets/favicon221b.png?1481775169361') }}"
        type="image/x-icon" />
                            ...
                            <div class="item">
                                <div class="article">
                                    <a href="" class="image"> <img
                                            src="{{ asset('image/new/' . $item->image) }}" alt="{{ $item->name }}"
                                            title="{{ $item->name }}" class="img-responsive"
                                            style="height: 170px; width: 550px;"></a>
                                    <div class="info">
