...
<div class="top-header">
  <div class="container">
    <div class="row">
      <div class="col-xs-12 col-sm-6 col-md-6"> <span><i class="fa fa-phone"></i> <a href="tel:phonenumber">(02) 6674 2332</span></a> <span><i class="fa fa-envelope-o"></i> <a href="mailto:support@mail.com">support@mail.com</a></span> </div>
...
<div class="container">
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-3 logo "> <a href="index.html"> <img src="../assets/frontend/banner/logoShop.jpg?"
    style="height: 60px;" alt="DKT Store" title="DKT Store" class="img-responsive"> </a> </div>
